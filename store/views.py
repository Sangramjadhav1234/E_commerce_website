...
class CheckOut(View):
    def get(self, request):
        ...
        # If the cart is empty, redirect to the store or another appropriate page
        if not cart:
            return redirect('store')  # Or any other page, e.g., 'store'
    ...
    def post(self, request):
        ...
        # Process the order for each product in the cart
